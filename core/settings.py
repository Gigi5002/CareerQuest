...
SECRET_KEY = 'django-insecure-ngb=!za4ro(z2(_8a#i5cmq4b8jo%_c=xq_j2s_%ez&kwlw^b&'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'careerquest',  # Имя вашей базы данных
        'USER': 'careerquest',      # Имя вашего пользователя
        'PASSWORD': 'careerquest',  # Ваш пароль
